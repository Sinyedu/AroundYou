        ...
        <div class="flex flex-col gap-8">
          ...
          <div class="grid gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
            <div>
              ...
              <div v-else-if="errorMessage" class="rounded-2xl bg-rose-50 p-6 text-sm font-semibold text-rose-700">
                {{ errorMessage }}
              </div>
              <div v-else class="space-y-5">
                ...
                <nav v-if="totalPages > 1" class="flex flex-wrap items-center justify-center gap-2" aria-label="Resultatsider">
                  <button
                    type="button"
