    ...
    <div class="relative z-10 mx-[50px] bg-white shadow-2xl rounded-xl overflow-hidden">
      <section class="px-8 py-10">
        ...
        <div class="mt-3 grid gap-3 lg:grid-cols-[1fr_auto] lg:items-end">
          <div>
            <h1 class="text-3xl font-black tracking-tight text-[#094b7b]">Kontakt board</h1>
            <p class="mt-2 max-w-3xl text-sm text-slate-600">
              Send fejl, rapporter og andre henvendelser direkte til admin. Hvis admin har brug for
              mere information, kan du blive kontaktet på emailen fra din konto.
            </p>
          </div>
      ...
      <div class="grid gap-6 lg:grid-cols-[minmax(0,0.82fr)_minmax(0,1fr)]">
        ...
        >
          ...
          <fieldset class="mt-5 grid gap-3">
            <legend class="text-sm font-black text-slate-800">Kategori</legend>
            <label
          ...
          <label class="mt-5 block">
            <span class="text-sm font-black text-slate-800">Titel</span>
            <input
          ...
          <label class="mt-4 block">
            <span class="text-sm font-black text-slate-800">Besked</span>
            <textarea
